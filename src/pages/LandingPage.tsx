  ...
  const featureShowcases = [
    {
      badge: "ANALYTICS",
      badgeColor: "#6366f1",
      title: "See True Profitability, Not Vanity Metrics",
      description: "Track every dollar from ad spend to actual profit. Factor in COGS, referral fees, and returns to see which products truly make money — not just which ones have low ACOS.",
      cta: "Explore Profit Dashboard",
      route: "/dashboard",
      gradient: "linear-gradient(135deg, #f97316 0%, #ec4899 40%, #8b5cf6 100%)",
      cardTitle: "Profit Analyzer",
      cardSub: "Q1 2026 · All Campaigns",
      cardIcon: DollarSign,
      items: [],
      metrics: [
        { icon: DollarSign, value: "$4.2K", label: "True Profit", change: "+18%", changeColor: "#10b981" },
        { icon: TrendingUp, value: "3.8x", label: "Real ROAS", change: "+23%", changeColor: "#10b981" },
        { icon: Target, value: "18%", label: "TACOS", change: "-5%", changeColor: "#10b981" },
      ],
      barChart: [
        { label: "Product A", value: 85, max: 100 },
        { label: "Product B", value: 62, max: 100 },
        { label: "Product C", value: 48, max: 100 },
        { label: "Product D", value: 35, max: 100 },
      ],
    },
    {
      badge: "AI-POWERED",
      badgeColor: "#10b981",
      title: "AI Recommendations in Plain English",
      description: "Upload your bulk files and let our AI analyst review your campaigns. Get actionable suggestions — bid adjustments, budget reallocation, keyword opportunities — all automated.",
      cta: "Try AI Analyst",
      route: "/dashboard",
      gradient: "linear-gradient(135deg, #ec4899 0%, #06b6d4 50%, #1e3a5f 100%)",
      cardTitle: "AI Campaign Analyst",
      cardSub: "Campaign analysis",
      cardIcon: Brain,
      items: [
        { icon: Check, label: "Bid Adjustments", sub: "12 campaigns need bid changes", badge: "Ready", badgeColor: "#10b981" },
        { icon: Check, label: "Budget Reallocation", sub: "$340/mo potential savings", badge: "3 suggestions", badgeColor: "#6366f1" },
        { icon: Check, label: "Keyword Opportunities", sub: "8 new exact match targets", badge: "High Impact", badgeColor: "#f59e0b" },
        { icon: Check, label: "Wasted Spend", sub: "$127 on non-converting terms", badge: "Action Needed", badgeColor: "#ef4444" },
      ],
      footer: { label: "4 optimization areas identified", color: "#10b981" },
    },
    {
      badge: "SEARCH TERMS",
      badgeColor: "#f59e0b",
      title: "Stop Bleeding Money on Bad Keywords",
      description: "Isolate high-converting search terms, kill the losers, and discover opportunities hidden in your campaign data. See exactly where your ad spend goes — and where it's wasted.",
      cta: "See Search Analytics",
      route: "/dashboard",
      gradient: "linear-gradient(135deg, #6366f1 0%, #8b5cf6 40%, #ec4899 100%)",
      cardTitle: "Search Term Hub",
      cardSub: "Last 30 days · SP Campaigns",
      cardIcon: Search,
      items: [
        { icon: Search, label: "wireless charger stand", value: "$1,240", badge: "Winner", badgeColor: "#10b981" },
        { icon: Search, label: "phone charger pad", value: "$890", badge: "Potential", badgeColor: "#6366f1" },
        { icon: Search, label: "charging dock station", value: "$45", badge: "Wasted", badgeColor: "#ef4444" },
        { icon: Search, label: "usb c fast charge", value: "$320", badge: "Isolate", badgeColor: "#f59e0b" },
      ],
    },
    {
      badge: "DAYPARTING",
      badgeColor: "#06b6d4",
      title: "Know When Your Ads Actually Convert",
      description: "Hour-by-hour performance heatmaps reveal when your campaigns peak and when they waste money. Optimize bid schedules based on real conversion data, not guesswork.",
      cta: "View Dayparting",
      route: "/dashboard",
      gradient: "linear-gradient(135deg, #06b6d4 0%, #3b82f6 50%, #6366f1 100%)",
      cardTitle: "Hourly Performance",
      cardSub: "Weekly heatmap · All campaigns",
      cardIcon: CalendarClock,
      items: [
        { icon: Clock, label: "Peak Hours", sub: "9 AM – 11 AM, 7 PM – 9 PM", badge: "High CVR", badgeColor: "#10b981" },
        { icon: Clock, label: "Dead Zones", sub: "1 AM – 5 AM", badge: "Low ROI", badgeColor: "#ef4444" },
        { icon: Clock, label: "Opportunity", sub: "Saturday 3 PM – 6 PM", badge: "Untapped", badgeColor: "#f59e0b" },
      ],
      footer: { label: "Optimal schedule identified", color: "#06b6d4" },
    },
  ];
        ...
        >
          <div className="flex items-center gap-4 sm:gap-8">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <a href="#" className="hover:text-foreground transition-colors">Free Audit</a>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <Button onClick={() => navigate("/auth")} size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-4 sm:px-5 text-xs sm:text-sm">Get a Free Audit</Button>
            </div>
          </div>
        </motion.nav>
