        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              onClick={() => navigate("/auth")}
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold text-lg px-8 py-6 rounded-xl group"
            >
              Start Analyzing Now
            ...
            <Button 
              ...
              className="border-border text-foreground hover:bg-muted font-bold text-lg px-8 py-6 rounded-xl"
            >
              See What You Get
            </Button>
          </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="rounded-xl border border-border overflow-hidden">
                ...
                {[
                  ...
                  <div key={i} className="grid grid-cols-5 gap-4 p-4 border-b border-border last:border-0 text-sm">
      ...
      <section className="py-24 px-6 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <Button 
            onClick={() => navigate("/auth")}
            size="lg"
            className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold text-xl px-12 py-7 rounded-xl group"
          >
            Get Started Free
      ...
      <footer className="py-24 px-6 border-t border-border">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="relative mb-12">
            ...
            <div className="relative w-24 h-24 rounded-2xl bg-primary flex items-center justify-center shadow-[0_0_60px_rgba(178,255,0,0.5)]">
          ...
          <img src={lynxLogoFull} alt="Lynx Media" className="h-8 opacity-60" />
