...
const App: React.FC = () => {
  ...
  const loadDemoData = () => {
    ...
    setTimeout(() => {
      ...
      setBulkData(mockCurrent);
      setPreviousBulkData(mockPrevious);
      ...
      if (mockCurrent.mockCosts) setProductCosts(mockCurrent.mockCosts);
      if (mockCurrent.mockGoals) setProductGoals(mockCurrent.mockGoals);
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      default: return <ExecutiveDashboard data={dashboardData} settings={settings} />;
    }
  };
